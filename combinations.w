\datethis
@* Copyright MetaverseX. May 4, 2023. Introduction. This program creates combinations of T traits, each of which have V variants. We have directories 1,2,3...T. Each directory has files 1,2,...V. We combine the files from the ith directory in each possible combination. This creates all combinations of files 1,1...1 (T times) 1,1...2 1,1...3 1,1...V ... V,V,...V.
